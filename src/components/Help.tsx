    ...
    <>
      ...
      <div className="help-section">
        ...
        <ul className="help-list">
          ...
          <li><strong>Full-mix instrument detection</strong>: an opt-in toggle in the converter for real songs. The mix is split into stems (drums, bass, guitar, piano, vocals, other) with a neural network running locally in your browser, then each stem is transcribed onto the board with its own instrument — drums land on the Drumkit. First use downloads a ~131 MB model (cached afterwards); a full song takes minutes of heavy CPU. Results are a starting point to edit, not a faithful cover.</li>
